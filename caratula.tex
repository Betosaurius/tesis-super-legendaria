...
\titulo{POLARITY AND RELATED CONCEPTS IN GRAPHS FREE OF THE FIVE VERTEX PATH AND ITS COMPLEMENT}
\nombre{\uppercase{HUMBERTO LOZANO CH\'AVEZ}}
\carrera{MAESTRO EN CIENCIAS}
...
\begin{minipage}[c][9.5cm][s]{10cm}
  \begin{center}
    ...
    QUE PARA OPTAR POR EL GRADO DE:\\[3pt]
    \mbox{}\lacarrera\\[13pt]
    PRESENTA:\\[3pt]
    \elnombre
