...
%Bibliografía
\usepackage[backend=biber, style=vancouver, sorting=nyt]{biblatex}
...
\usepackage{tikz}
\usetikzlibrary{arrows,shapes,matrix,decorations,calc,positioning,fit,shapes.geometric,backgrounds, decorations.pathmorphing}
