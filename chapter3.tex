...
an induced copy of $C_5$.


\section{Characterization of monopolarity}
\label{sec:c5_characterization}

Note that, for all graphs in the present chapter with an induced copy of $C_5$,
the labelling of the vertices of the 5-cycle is determined by the drawing shown
...
copy of $C_5$ (that, by chance, was not detected by the algorithm that verifies
